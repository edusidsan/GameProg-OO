...
namespace OgrO
{
    namespace MultiplesThreads
    {
        ...
        ThreadWitch::ThreadWitch(Utilities::gameVector2F pos, Utilities::gameVector2F s, const char *tPath) : PhysicalEntities::Characters::Enemies::Witch(pos, s, tPath),
                                                                                                              keep_going{true},
                                                                                                              paused{false}
        {
        }
...
>>>>>>> fb20515359f32115f0682ff8f5b9692af6890989
